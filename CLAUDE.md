...
| Install locally | `code --install-extension claude-overwrite-features-0.6.18.vsix` |
...
| Minified name | Role |
|---|---|
| `De1` (v2.1.204: `_Qe`) | Main chat view — owns attachedFiles and includeSelection state. Signature: `function _Qe({session:e,context:t,...})` |
...
| Semantic role | v2.1.162 | v2.1.165 | v2.1.170 | v2.1.172 | v2.1.174 | v2.1.177 | v2.1.178 | v2.1.179 | v2.1.186 | v2.1.187 | v2.1.190 | v2.1.191 | v2.1.193 | v2.1.195 | v2.1.196 | v2.1.198 | v2.1.200 | v2.1.202 | v2.1.204 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| includeSelection state | `[P,_]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[C,x]` | `[C,x]` | `[C,x]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` |
| attachedFiles state | `[B,W]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` |
| next state after includeSelection | `[M,w]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[y,w]` | `[y,w]` | `[y,w]` | `[x,w]` | `[x,w]` | `[x,w]` | `[x,w]` | `[x,w]` | `[x,w]` | `[x,w]` | `[x,w]` |
| submit callback | `C` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `H` (`Vt`/useCallback) | `H` (`Vt`/useCallback) | `H` (`Vt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) | `H` (`Wt`/useCallback) |
| command text arg | `v1` | `Oe` | `q` | `$` | `$` | `$` | `$` | `$` | `K` | `K` | `K` | `K` | `K` | `K` | `K` | `K` | `K` | `K` | `ne` |
| isSlashCommand flag | `q1` | `ae` | `De` | `De` | `De` | `De` | `De` | `De` | `Ne` | `Ne` | `Ne` | `Me` | `Ee` | `Ee` | `Ee` | `Ee` | `Ee` | `Ee` | `Je` |
| effective includeSelection | `l1` | `je` | `_t` | `gt` | `gt` | `gt` | `gt` | `gt` | `bt` | `bt` | `bt` | `bt` | `_t` | `_t` | `_t` | `_t` | `_t` | `_t` | `Dt` |
| compact button onCompact | `J` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` | `i` |
| scroll fn / scroll ref | `Nk` / `Q` | `IN` / `r` | `BN` / `r` | `BN` / `r` | `VN` / `r` | `VN` / `r` | `zN` / `r` | `zN` / `r` | `TM` / `r` | `DM` / `r` | `DM` / `r` | `ND` / `r` | `MD` / `r` | `PD` / `r` | `PD` / `r` | `PD` / `r` | `PD` / `r` | `PD` / `r` | `OD` / `r` |
...
|---|---|---|
| 1 (includeSelection default) | `webview/index.js` | `"selectionLabel"` CSS class string nearby, or the main chat view component signature (v2.1.204: `function _Qe({session:`; component name changes each release). The three consecutive `useState` calls are `_=Se(!0),[C,y]=ie(!0),[x,w]=ie(!1)` — flip the middle `[C,y]` init from `!0` to `!1` |
