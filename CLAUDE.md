...
| Install locally | `code --install-extension claude-overwrite-features-0.6.5.vsix` |
...
| Semantic role | v2.1.162 | v2.1.165 | v2.1.170 | v2.1.172 | v2.1.174 | v2.1.177 | v2.1.178 |
|---|---|---|---|---|---|---|---|
| React namespace | `n1` | `Ye` | `Ke` | `Ke` | `Ke` | `Ke` | `je` |
| includeSelection state | `[P,_]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` | `[v,x]` |
| attachedFiles state | `[B,W]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` | `[h,p]` |
| next state after includeSelection | `[M,w]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` | `[C,y]` |
| submit callback | `C` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) | `F` (useCallback) |
| command text arg | `v1` | `Oe` | `q` | `$` | `$` | `$` | `$` |
| isSlashCommand flag | `q1` | `ae` | `De` | `De` | `De` | `De` | `De` |
| effective includeSelection | `l1` | `je` | `_t` | `gt` | `gt` | `gt` | `gt` |
| compact button onCompact | `J` | `i` | `i` | `i` | `i` | `i` | `i` |
| scroll fn / scroll ref | `Nk` / `Q` | `IN` / `r` | `BN` / `r` | `BN` / `r` | `VN` / `r` | `VN` / `r` | `zN` / `r` |
