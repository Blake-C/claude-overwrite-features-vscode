...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send($,h,gt),p([]),BN(r,!0)',
		to: 'await e.send($,De?[]:h,gt),p([]),x(!1),BN(r,!0)',
	},
	{
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let o=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return Mse(t,o),o.result}',
