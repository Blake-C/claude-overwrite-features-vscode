...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:V};let Z=await this.sendRequest(z,{type:"tool_permission_request",toolName:K,inputs:V,suggestions:x},N);return G80(K,Z),Z.result}',
