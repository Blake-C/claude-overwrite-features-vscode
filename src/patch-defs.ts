...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(K,h,ct),p([]),PD(r,!0)',
		to: 'await e.send(K,De?[]:h,ct),p([]),y(!1),PD(r,!0)',
	},
	{
