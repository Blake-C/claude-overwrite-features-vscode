...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await $.send(D1,W,R0,{kind:"human"}),B([]),oh(Q,!0)',
		to: 'await $.send(D1,Y0?[]:W,R0,{kind:"human"}),B([]),E(!1),oh(Q,!0)',
	},
	{
