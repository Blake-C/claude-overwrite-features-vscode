...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(xe,h,jt,{kind:"human"}),p([]),kN(r,!0)',
		to: 'await e.send(xe,Lt?[]:h,jt,{kind:"human"}),p([]),x(!1),kN(r,!0)',
	},
	{
