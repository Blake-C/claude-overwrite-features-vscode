...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(ne,h,Dt),p([]),OD(r,!0)',
		to: 'await e.send(ne,Je?[]:h,Dt),p([]),y(!1),OD(r,!0)',
	},
	{
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let s=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return Bce(t,s),s.result}',
