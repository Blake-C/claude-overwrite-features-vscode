...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(K,h,ct),p([]),OD(r,!0)',
		to: 'await e.send(K,De?[]:h,ct),p([]),y(!1),OD(r,!0)',
	},
	{
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let s=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return Kle(t,s),s.result}',
