...
export const PATCHES: Patch[] = [
	{
		...
		from: 'D=D1(!0),[M,_]=Y1(!0),[w,O]=Y1(!1)',
		to: 'D=D1(!0),[M,_]=Y1(!1),[w,O]=Y1(!1)',
	},
	{
		name: 'Feature 2: Skip attachments + reset toggle on slash commands',
		from: 'await $.send(g,B,q1,{kind:"human"}),W([]),Jy(Z,!0)',
		to: 'await $.send(g,Q1?[]:B,q1,{kind:"human"}),W([]),_(!1),Jy(Z,!0)',
	},
	{
