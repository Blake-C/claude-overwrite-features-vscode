...
export const PATCHES: Patch[] = [
	{
		...
		from: '_=we(!0),[C,y]=ie(!0),[x,w]=ie(!1)',
		to: '_=we(!0),[C,y]=ie(!1),[x,w]=ie(!1)',
	},
	{
		name: 'Feature 2: Skip attachments + reset toggle on slash commands',
		from: 'await e.send(ve,h,bt,{kind:"human"}),p([]),HD(r,!0)',
		to: 'await e.send(ve,_t?[]:h,bt,{kind:"human"}),p([]),y(!1),HD(r,!0)',
	},
	{
