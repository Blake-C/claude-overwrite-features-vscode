...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(ve,h,Vt,{kind:"human"}),p([]),EN(r,!0)',
		to: 'await e.send(ve,rt?[]:h,Vt,{kind:"human"}),p([]),x(!1),EN(r,!0)',
	},
	{
