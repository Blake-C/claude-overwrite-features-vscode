...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let o=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return Lse(t,o),o.result}',
