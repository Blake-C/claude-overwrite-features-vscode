...
export const PATCHES: Patch[] = [
	{
		...
		from: '_=ge(!0),[C,x]=ne(!0),[y,w]=ne(!1)',
		to: '_=ge(!0),[C,x]=ne(!1),[y,w]=ne(!1)',
	},
	{
		name: 'Feature 2: Skip attachments + reset toggle on slash commands',
		from: 'await e.send(ve,h,Vt,{kind:"human"}),p([]),TN(r,!0)',
		to: 'await e.send(ve,st?[]:h,Vt,{kind:"human"}),p([]),x(!1),TN(r,!0)',
	},
	{
