...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let s=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return uue(t,s),s.result}',
