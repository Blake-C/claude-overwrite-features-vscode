...
export const PATCHES: Patch[] = [
	{
		...
		from: '_=ge(!0),[C,x]=ie(!0),[y,w]=ie(!1)',
		to: '_=ge(!0),[C,x]=ie(!1),[y,w]=ie(!1)',
	},
	{
		name: 'Feature 2: Skip attachments + reset toggle on slash commands',
		from: 'await e.send(ve,h,O,{kind:"human"}),p([]),TN(r,!0)',
		to: 'await e.send(ve,ot?[]:h,O,{kind:"human"}),p([]),x(!1),TN(r,!0)',
	},
	{
