...
export const PATCHES: Patch[] = [
	...
	},
	{
		...
		from: 'await e.send(H,h,le,{kind:"human"}),p([]),FN(r,!0)',
		to: 'await e.send(H,ne?[]:h,le,{kind:"human"}),p([]),x(!1),FN(r,!0)',
	},
	{
