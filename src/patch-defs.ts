...
export const PATCHES: Patch[] = [
	{
		...
		from: '_=je.useRef(!0),[v,x]=je.useState(!0),[C,y]=je.useState(!1)',
		to: '_=je.useRef(!0),[v,x]=je.useState(!1),[C,y]=je.useState(!1)',
	},
	{
		name: 'Feature 2: Skip attachments + reset toggle on slash commands',
		from: 'await e.send($,h,gt),p([]),zN(r,!0)',
		to: 'await e.send($,De?[]:h,gt),p([]),x(!1),zN(r,!0)',
	},
	{
	...
	},
	{
		...
		from: 'return{behavior:"allow",updatedInput:r};let o=await this.sendRequest(e,{type:"tool_permission_request",toolName:t,inputs:r,suggestions:i},n);return aoe(t,o),o.result}',
